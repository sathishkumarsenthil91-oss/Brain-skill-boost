...
public class MainActivity extends Activity {
    ...
    private void configureWebView() {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " BrainBoostAndroid/4.0");
    ...
    private void applySystemBarTheme(boolean darkMode) {
        ...
        int barColor = darkMode ? Color.rgb(11, 19, 41) : Color.WHITE;
    ...
    private void showRunningNotification() {
        ...
        Notification notification = builder
                ...
                .setContentText("Tap to return to Brain boost")
